...
import sty from "./PlasmicButton.module.css"; // plasmic-import: r24vnAeLYkYV/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: FECicJOiW3or/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg___8U7Wp)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__iTfFx)}
                role={"img"}
              />
            ),
